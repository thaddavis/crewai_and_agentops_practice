...
# from frequency_music_crew.tools.custom_tool import MyCustomTool

# Check our tools documentations for more information on how to use them
# from crewai_tools import SerperDevTool

@CrewBase
class FrequencyMusicCrewCrew():
	...
	def producing(self) -> Task:
		return Task(
			...
			output_file='produced_song.md'
		)

	@crew
	def crew(self) -> Crew:
		"""Creates the FrequencyMusicCrew crew"""
		return Crew(
